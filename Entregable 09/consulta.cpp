...
Consulta::Consulta(Fecha valorFecha, Hora valorHora, Paciente valorPaciente, Medico valorMedico,
Diagnostico valorDiagnostico, Medicamento valorMedicamento1, Medicamento valorMedicamento2,
Medicamento valorMedicamento3) : fecha(valorFecha), hora(valorHora), paciente(valorPaciente),
...
Consulta::Consulta(const Consulta& copia) : fecha(copia.fecha), hora(copia.hora), paciente(copia.paciente), medico(copia.medico),
...
std::ostream& operator << (std::ostream& out, const Consulta& objSalida) {
    out << objSalida.fecha << objSalida.hora << objSalida.paciente 
